...
urlpatterns = [
    ...
    url(r'^deploymentfact/list', fact_list, name='deploymentfact'),
    url(r'^deploymentfact/request', fact_request, name='test'),
    url(r'^deploymentfact/create', fact_create, name='fact'),
]
